...
class WebSocketsClient : protected WebSockets {
  public:
    ...
    typedef std::function<void(WStype_t type, uint8_t * payload, size_t length, void* ptr)> WebSocketClientEventWithParam;
#endif
    ...
    void onEvent(WebSocketClientEventWithParam cbEventWithParam, void* ptr);
...
#define SSL_FINGERPRINT_NULL NULL
    ...
    WebSocketClientEventWithParam _cbEventWithParam;
    void* _cbEventParam;
    ...
    virtual void runCbEvent(WStype_t type, uint8_t * payload, size_t length) {
        ...
        if(_cbEventWithParam) {
            _cbEventWithParam(type, payload, length, _cbEventParam);
        }
    }
};
