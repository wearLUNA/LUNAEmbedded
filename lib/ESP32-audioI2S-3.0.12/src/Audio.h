...
public:
    Audio(const char *root_ca, bool internalDAC = false, uint8_t channelEnabled = 3, uint8_t i2sPort = I2S_NUM_0); // #99
    ~Audio();
    ...
    bool connecttorequest(const char * host, String &request_str, uint8_t *payload_buf, size_t payload_len, bool ssl = true, uint8_t expected_codec = CODEC_WAV);
